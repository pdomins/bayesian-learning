...
def plot_roc_from_positive_rates(positive_rates : list[dict[str, Any]], title : str, save_file : str = None, annotate : bool = False, font_size : int = 5, label : str = None):
    plt.figure()
    __add_roc_plot_template__(title)
    add_roc_plot_from_positive_rates(positive_rates, annotate, font_size, label=label)
